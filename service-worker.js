...
var CACHE_NAME = 'meallog-v6';   /* Claude ver06 */
var ASSETS = [
  './',
  'index.html',
  'css/style.css?v=20260905-06',
  'js/store.js?v=20260905-06',
  'js/foods.js?v=20260905-06',
  'js/nutrition.js?v=20260905-06',
  'js/barcode.js?v=20260905-06',
  'js/ui-meal.js?v=20260905-06',
  'js/ui-body.js?v=20260905-06',
  'js/ui-graph.js?v=20260905-06',
  'js/ui-advice.js?v=20260905-06',
  'js/ui-settings.js?v=20260905-06',
  'js/app.js?v=20260905-06',
  'vendor/zxing.min.js',
  'data/foods.json',
  'data/common.json',
